...
impl Range{
    pub fn new(start: usize, end: usize) -> Self{   //or should this error if start > end instead?... maybe an assert makes sense here?
    ...
    pub fn intersection(&self, other: &Range) -> Option<Self>{
