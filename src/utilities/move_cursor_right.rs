...
mod tests{
    ...
    //    let result = move_cursor_right::document_impl(&mut doc, semantics);
    ...
    //        .with_text(text.clone())
    //        .with_selections(Selections::new(selections, primary, &text, semantics));
    //    assert!(move_cursor_right::document_impl(&mut doc, semantics).is_err());
    //    assert!(!doc.is_modified());
    //}
    ...
    #[test] fn with_multiple_valid_selections_bar_semantics(){
        ...
        //        Selection::new(Range::new(8, 8), Direction::Forward),   //line to line updates stored line position
        //        Selection::new(Range::new(10, 13), Direction::Forward), //extended selection collapses then moves normally
        //    ], 0, 
        //    vec![
    ...
    #[test] fn with_multiple_valid_selections_block_semantics(){
        ...
        //        Selection::new(Range::new(8, 9), Direction::Forward),   //line to line updates stored line position
        //        Selection::new(Range::new(10, 13), Direction::Forward), //extended selection collapses then moves normally
        //    ], 0, 
        //    vec![
