...
fn primary_cursor_position(){
    ...
    let selections = Selections::new(vec![Selection::new(Range::new(0, 3), Direction::Forward)], 0, &text);
...
fn primary_cursor_position_with_cursor_outside_view(){
    ...
    let selections = Selections::new(vec![Selection::new(Range::new(9, 13), Direction::Forward)], 0, &text);
