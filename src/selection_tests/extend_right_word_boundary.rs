...
//    assert_eq!(Selection::with_stored_line_position(Range::new(0, 3), Direction::Forward, 2), Selection::new(Range::new(0, 1), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Block).unwrap());
...
//    assert_eq!(Selection::with_stored_line_position(Range::new(0, 3), Direction::Forward, 3), Selection::new(Range::new(0, 0), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Bar).unwrap());
//}
//
//// bar
...
//        assert_eq!(Selection::with_stored_line_position(Range::new(13, 14), Direction::Forward, 0), Selection::new(Range::new(13, 13), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Bar).unwrap());
//    }
...
//        assert!(Selection::new(Range::new(14, 14), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Bar).is_err());
//    }
...
//        assert!(Selection::new(Range::new(0, 14), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Bar).is_err());
//    }
...
//        assert!(Selection::new(Range::new(0, 14), Direction::Backward).extend_right_word_boundary(&text, CursorSemantics::Bar).is_err());
//    }
//
//// block
...
//        assert_eq!(Selection::with_stored_line_position(Range::new(12, 14), Direction::Forward, 4), Selection::new(Range::new(12, 13), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Block).unwrap());
//    }
...
//        assert!(Selection::new(Range::new(13, 14), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Block).is_err());
//    }
...
//        assert!(Selection::new(Range::new(0, 14), Direction::Forward).extend_right_word_boundary(&text, CursorSemantics::Block).is_err());
//    }
...
//        assert!(Selection::new(Range::new(0, 14), Direction::Backward).extend_right_word_boundary(&text, CursorSemantics::Block).is_err());
//    }
//