...
#[test] fn verify_cursor_past_doc_text(){
    let text = Rope::from("idk\nsome\nshit\n");
    //assert_eq!(false, Selection::new(14, 15).spans_multiple_lines(&text, CursorSemantics::Block)); // i d k \n s o m e \n s h i t \n|: >
    assert_eq!(false, Selection::new(Range::new(14, 15), Direction::Forward).spans_multiple_lines(&text, CursorSemantics::Block)); // i d k \n s o m e \n s h i t \n|: >
    //assert_eq!(false, Selection::new(15, 14).spans_multiple_lines(&text, CursorSemantics::Block)); // i d k \n s o m e \n s h i t \n< |
