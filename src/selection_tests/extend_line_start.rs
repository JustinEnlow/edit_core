...
//    assert!(Selection::new(Range::new(0, 0), Direction::Forward).extend_line_start(&text, CursorSemantics::Bar).is_err());
//    //assert!(Selection::new(0, 1).extend_home(&text, CursorSemantics::Block).is_err());
//    assert!(Selection::new(Range::new(0, 1), Direction::Forward).extend_line_start(&text, CursorSemantics::Block).is_err());
//}
//